      ...
      <div className="card-group">
        <div className="card">
          ...
          <p className="details">
            ...
            car details, contact and visit information and details of his shop. Also, he needs a personal page in this website, where customer will know about him in details.
